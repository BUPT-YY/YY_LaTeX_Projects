...
\questiontext{
	计算当$n\to\infty$时, 序列\begin{equation*}
		\left\{\cos(\frac{\pi}{2n+1})\cos(\frac{2\pi}{2n+1})\cdots\cos(\frac{n\pi}{2n+1})\right\}
	\end{equation*}
	的等价无穷小.
}
\answer{
	\begin{proof}
		令\begin{equation*}
			a_n = \cos(\frac{\pi}{2n+1})\cos(\frac{2\pi}{2n+1})\cdots\cos(\frac{n\pi}{2n+1}).
		\end{equation*}
		知\begin{equation*}
			\lim\limits_{n\to\infty}2^na_n = 1.
		\end{equation*}
		因此, 所求的等价无穷小是$1/2^n$.
	\end{proof}
}
