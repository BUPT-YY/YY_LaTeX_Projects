...
\questiontext{
	试证以下的集合等式, 其中$\mathbb{N}$是自然数集:
	\begin{equation*}
		\bigcap_{n\in\mathbb{N}}\left( \frac{n}{n+1},+\infty \right) = [1,+\infty).
	\end{equation*}
}
\answer{
	\begin{proof}
		一方面, 由于$1>\frac{n}{n+1}$, 所以$x\geqslant 1\Rightarrow x>\frac{n}{n+1}$.
		
		故\begin{equation*}
			\forall n\in\mathbb{N},~[1,+\infty)\subseteq \left( \frac{n}{n+1},+\infty \right).
		\end{equation*}
		
		因而有\begin{equation*}
			[1,+\infty)\subseteq \bigcap_{n\in\mathbb{N}}\left( \frac{n}{n+1},+\infty \right).
		\end{equation*}
		另一方面, 若$x\notin [1,+\infty)$, 则$x<1$,
		
		从而$0<\frac{1}{1-x}$. 再根据实数有Archimedes性知道
		\begin{equation*}
			\exists N_0\in\mathbb{N}, N_0>\frac{1}{1-x}.
		\end{equation*}
		从而\begin{equation*}
			x <\frac{N_0-1}{N_0}<\frac{N_0}{N_0+1}.
		\end{equation*}
		这说明\begin{equation*}
			x\notin \left( \frac{N_0}{N_0+1},+\infty \right).
		\end{equation*}
		根据交集的定义知道\begin{equation*}
			x\notin\bigcap_{n\in\mathbb{N}}\left( \frac{n}{n+1},+\infty \right).
		\end{equation*}
		因此,\begin{equation*}
			x\notin [1,+\infty) \Rightarrow x\notin\bigcap_{n\in\mathbb{N}}\left( \frac{n}{n+1},+\infty \right).
		\end{equation*}
		这说明\begin{equation*}
			[1,+\infty)\supseteq \bigcap_{n\in\mathbb{N}}\left( \frac{n}{n+1},+\infty \right).
		\end{equation*}
		根据集合相等的定义, 知结论成立.
	\end{proof}
}
